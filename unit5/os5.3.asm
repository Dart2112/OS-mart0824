...
.segmentdef Zeropage [min=$bf00, max=$bfff, fill]
  ...
  .const JMP = $4c
  .const NOP = $ea
  .label running_pdb = $26
  .label pid_counter = $27
  .label lpeek_value = $28
...
// dma_copy(dword zeropage(6) src, dword zeropage(2) dest, word zeropage($14) length)
dma_copy: {
    .label __0 = $29
    .label __2 = $2d
    .label __4 = $45
...
.segment Code
// print_dhex(dword zeropage($f) value)
print_dhex: {
    .label __0 = $3f
    .label value = $f
    lda #0
...
// memset(void* zeropage($43) str, byte register(X) c, word zeropage($14) num)
memset: {
    .label end = $14
    .label dst = $43
    .label num = $14
